...
当前版本：**V0.18.3 — Stage 17 Geographic Map**
...
- 正式 World Map Content V1：48 客运站 + 120 道路段 + 五级道路编号/四级缩放显示
...
Stage 17 正在进行：全国图已从规则网格重排为地理走廊结构，西部稀疏、东部更密；全国总览只显示高速，放大后依次显示国道、省道、县乡道。山脉、丘陵、河流、湖泊与海岸加入纯装饰背景，不参与寻路或经营计算。详细规范见 docs/ROAD_NETWORK_STYLE_GUIDE.md。

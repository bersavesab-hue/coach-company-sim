...
当前版本：**V0.18.8 — Stage 17 Map Presentation**
...
Stage 17 正在进行：路网形态与地图表现同步推进。道路视觉统一为国内导航图式绿色系；城市按 hub/city/county/town 四级标记大小；地图城市解锁正式绑定公司声誉；地图画布扩展到主界面可用高度；玩家开通的客运线路沿真实 RoadSegment 几何以暖色覆盖显示。

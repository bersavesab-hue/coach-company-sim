...
当前版本：**V0.19.7 — Stage 17 Reference Road Network**
...
Stage 17 新高速路网已按确认的参考图正式接入：原绿色高速几何整体替换为三条自然横向主走廊 + 西部联络 + 中央斜向联络 + 东部沿海联络；34 个正式高速 RoadSegment ID 继续复用，国道、省道、县乡道与底图体系保持原有正式实现。

...
当前版本：**V0.18.1 — Stage 17 Map/UI Rework**
...
Stage 17 正在进行：正式地图已改为客运站 + 道路枢纽 + 五级路网结构，APK 以地图为主界面并按缩放级别显示道路与站点。手机地图编辑器位于 tools/map-editor/index.html，导出的 world-map.v1.json 可直接替换正式地图数据。

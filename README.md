...
当前版本：**V0.18.7 — Stage 17 Domestic Road Morphology**
...
- 正式 World Map Content V1：48 客运站 + 130 道路节点 + 200 道路段 + 不规则城市外环/真实互通/五级路网
...
Stage 17 正在进行：河源—永安—云州起步城市群已按国内真实公路网的组织逻辑重排。三个规则方环已经删除，改为 6/7/6 段不规则外环；H02/H21/H12/H03 及 N102/N201/N202 等主要走廊改为多控制点自然曲线，默认区域视角只显示主干路网，细支路随缩放展开。

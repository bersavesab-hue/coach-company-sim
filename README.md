...
当前版本：**V0.18.4 — Stage 17 Road Network**
...
Stage 17 正在进行：地图底层从“道路连线”升级为正式路网。长距离道路被拆成多个道路节点和路段，重点枢纽城市加入环线与接驳路，高速互通/城市环线/区域路口全部成为正式 junction；渲染层使用平滑道路带和互通节点，缩放后逐层展开国道、省道、县乡道。
